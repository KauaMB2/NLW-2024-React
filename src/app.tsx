          ...
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className="flex items-center gap-2 flex-1">
              ...
              <input
                ...
                className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1 text-white"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                type="text"
                placeholder="Quando?"
                className="bg-transparent text-lg placeholder-zinc-400 w-40 outline-none text-white"
              />
            </div>
